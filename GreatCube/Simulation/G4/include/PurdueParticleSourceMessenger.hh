#ifndef __PURDUEPARTICLESOURCEMESSENGER_H__
#define __PURDUEPARTICLESOURCEMESSENGER_H__
...
class PurdueParticleSourceMessenger: public G4UImessenger
{
public:
	PurdueParticleSourceMessenger(PurdueParticleSource *pParticleSource);
	~PurdueParticleSourceMessenger();
