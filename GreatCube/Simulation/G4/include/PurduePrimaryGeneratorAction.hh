#ifndef __PURDUEPRIMARYGENERATORACTION_H__
#define __PURDUEPRIMARYGENERATORACTION_H__
...
class PurdueParticleSource;
class G4Event;

class PurduePrimaryGeneratorAction: public G4VUserPrimaryGeneratorAction
{
public:
	PurduePrimaryGeneratorAction(G4String fName);
	~PurduePrimaryGeneratorAction();
...
private:
 ...
 // messenger
 // PurduePrimaryGeneratorMessenger *m_pMessenger;
	//
	G4bool					 writeEmpty;
	...
	PurdueParticleSource	 *m_pParticleSource;
