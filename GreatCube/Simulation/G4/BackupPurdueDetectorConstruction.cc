...
PurdueDetectorConstruction::~PurdueDetectorConstruction()
{
  ...
  /*
  delete m_pLabLogicalVolume;
  delete m_pLabPhysicalVolume;

  //Walls
  delete m_pFrontWallLogicalVolume;
  delete m_pFrontWallPhysicalVolume;

  delete m_pBackWallLogicalVolume;
  delete m_pBackWallPhysicalVolume;

  delete m_pLeftWallLogicalVolume;
  delete m_pLeftWallPhysicalVolume;

  delete m_pRightWallLogicalVolume;
  delete m_pRightWallPhysicalVolume;

  delete m_pFloorLogicalVolume;
  delete m_pFloorPhysicalVolume;

  delete m_pCeilingLogicalVolume;
  delete m_pCeilingPhysicalVolume;

  //Detectors
  delete m_pDetectorContainer1LogicalVolume;
  delete m_pDetectorContainer1PhysicalVolume;

  delete m_pScintillator1LogicalVolume;
  delete m_pScintillator1PhysicalVolume;

  delete m_pDetectorContainer2LogicalVolume;
  delete m_pDetectorContainer2PhysicalVolume;

  delete m_pScintillator2LogicalVolume;
  delete m_pScintillator2PhysicalVolume;

  delete m_pDetectorContainer3LogicalVolume;
  delete m_pDetectorContainer3PhysicalVolume;

  delete m_pScintillator3LogicalVolume;
  delete m_pScintillator3PhysicalVolume;

  delete m_pBrickLogicalVolume
  delete m_pBrickPhysicalVolume;

  delete m_pLeadBrick1PhysicalVolume
...
void PurdueDetectorConstruction::ConstructCastle()
{
}
