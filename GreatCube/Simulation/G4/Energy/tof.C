...
int main(int argc, char **argv)
{
  ...
  */
  ...
  //cout<<"There are "<<eventsofinterest<<" possible double scatters."<<endl;
  //cout<<"Hits in detector 2 :"<<hitsintwo<<endl;
  //cout<<"Hits in detector 3 :"<<hitsinthree<<endl;
  /*
